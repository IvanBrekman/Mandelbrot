...
inline mmxf_t::mmxf_t (float  val)                                      : m (_mm_meow_ps1    (val))                    {}
...
inline mmxi_t::mmxi_t (int     val)                                     : m (_mm_meow_epi32  (val))                    {}
inline mmxi_t::mmxi_t (int     val1, int val2, int val3, int val4)      : m (_mm_meow_epi32  (val1, val2, val3, val4)) {}
...
inline int    operator +  (const mmxf_t& cmp)                { return _mm_movemeow_ps (cmp);  }
